...
var _PropTypes2 = require('react-bootstrap/lib/utils/PropTypes');
...
var propTypes = {
   ...
   * @required
   */
  id: (0, _isRequiredForA11y2.default)(_PropTypes.oneOfType([_PropTypes.string, _PropTypes.number])),
   ...
   * @type {node}
   */
  children: (0, _all2.default)((0, _PropTypes2.requiredRoles)(TOGGLE_ROLE, MENU_ROLE), (0, _PropTypes2.exclusiveRoles)(MENU_ROLE)),
