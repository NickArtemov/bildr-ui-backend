...
var _createClass = require('create-react-class');
...
function enableStateForPathname(pathname, params) {
  for (var pattern in routesStore) {
	//var re = _pathToRegExp([pattern], Object.keys)
	//if (re.exec(pathname) !== null) {
...
var MainContainer = _createClass((_React$createClass = {
