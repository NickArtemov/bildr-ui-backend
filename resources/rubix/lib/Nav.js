...
var propTypes = {
   ...
   */
  activeKey: _PropTypes.any,

  /**
   * Marks the child NavItem with a matching `href` prop as active.
   */
  activeHref: _PropTypes.string,
  ...
  justified: (0, _all2.default)(_PropTypes.bool, function (_ref) {
   ...
   */
  pullRight: _PropTypes.bool,

  /**
   * Float the Nav to the left. When `navbar` is `true` the appropriate
   * contextual classes are added as well.
   */
  pullLeft: _PropTypes.bool
};
...
var contextTypes = {
  $bs_navbar: _PropTypes.shape({
    bsClass: _PropTypes.string
  }),

  $bs_tabContainer: _PropTypes.shape({
    activeKey: _PropTypes.any,
    onSelect: _PropTypes.func.isRequired,
    getTabId: _PropTypes.func.isRequired,
    getPaneId: _PropTypes.func.isRequired
  })
};
